...
export default function App() {
  ...
  const styles = {
    ...
    bottomNav: { position: "fixed", bottom: 0, left: 0, right: 0, background: "#FFF", borderTop: "1px solid #E1DFDD", display: "flex", justifyContent: "space-around", padding: "12px 0", boxShadow: "0 -2px 8px rgba(0,0,0,0.05)", maxWidth: "480px", margin: "0 auto" },
